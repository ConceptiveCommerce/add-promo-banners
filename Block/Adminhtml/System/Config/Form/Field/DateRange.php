...
namespace Conceptive\Banners\Block\Adminhtml\System\Config\Form\Field;
...
protected function initScripts($options = array()) {
  ...
  if(!$startDate) {
    $startDate = 'moment().subtract(29, "days")';
        ...
        <script>
          require(["jquery",
          "Conceptive_Banners/vendors/moment/min/moment.min",
          "Conceptive_Banners/vendors/bootstrap-daterangepicker/daterangepicker"
