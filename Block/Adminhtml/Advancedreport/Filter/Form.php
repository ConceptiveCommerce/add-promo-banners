...
namespace Conceptive\Banners\Block\Adminhtml\Advancedreport\Filter;
class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    protected function _initFormValues()
    {
        ...
        $data = Array( "filter_from" => "$today_date","filter_to" => "$first_day_this_month","group_by" => "month" );
        // $data = $this->getFilterData()->getData();
        if($this->getFilterData() !== null){
            $data = $this->getFilterData()->getData();
        }
