...
use Conceptive\Banners\Model\Banners;
...
//use Conceptive\News\Model\ResourceModel\Test\CollectionFactory;
...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create('Conceptive\Banners\Model\Banners')->load($id);
            if (!$model->getId() && $id) {
            ...
            $banner_pos = implode(",", $data['position']);
            $model->setPosition($banner_pos);
            ...
            try {
                ...
                $this->dataPersistor->clear('conceptive_banners');
            ...
            $this->dataPersistor->set('conceptive_banners', $data);
